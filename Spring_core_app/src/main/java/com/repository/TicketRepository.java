...
public class TicketRepository {
    ...
    public void insert(Ticket ticket) {
        ...
        String sql = "insert into ticket(subject, details, ticket_priority, ticket_status, created_at) values (?,?,?,?,?)";
        ...
        return jdbcTemplate.query(sql, new RowMapper<Ticket>() {
            ...
            public Ticket mapRow(ResultSet rst, int rowNum) throws SQLException {
                ...
                return new Ticket(
                        ...
                        TicketStatus.valueOf(rst.getString("ticket_status")),
                        TicketPriority.valueOf(rst.getString("ticket_priority")),
                        rst.getTimestamp("created_at").toInstant()
                );
            }
        });
    }
